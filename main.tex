...
%
%  Supports: MLSys, NeurIPS, COLM, ICML, ICLR,
%            OSDI, NSDI,
...
\ifx\targetconference\conficml    \mlvenuetrue \fi
\ifx\targetconference\conficlr    \mlvenuetrue \fi
...
% --- NeurIPS, COLM, ICML, ICLR (condensed with numbered institutions) ---
\ifmlvenue
...
% --- NeurIPS, COLM, ICML, ICLR: maketitle then abstract ---
\ifmlvenue
    \ifx\targetconference\confmlsys\else
        \maketitle
        \emitauthorfn
